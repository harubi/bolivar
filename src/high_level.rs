...
/// # Example
/// ```ignore
/// use bolivar::high_level::{extract_text, ExtractOptions};
///
...
/// # Example
/// ```ignore
/// use bolivar::high_level::{extract_text_to_fp, ExtractOptions};
/// use std::fs::File;
///
/// let pdf_bytes = std::fs::read("document.pdf")?;
...
/// # Example
/// ```ignore
/// use bolivar::high_level::{extract_pages, ExtractOptions};
/// use bolivar::layout::LTTextBox;
///
/// let pdf_bytes = std::fs::read("document.pdf")?;
