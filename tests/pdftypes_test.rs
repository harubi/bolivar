...
use bolivar::pdftypes::{PDFObjRef, PDFObject, PDFStream};
...
#[allow(clippy::approx_constant)]
fn test_int_value() {
    use bolivar::pdftypes::int_value;
...
#[allow(clippy::approx_constant)]
fn test_num_value() {
    use bolivar::pdftypes::num_value;
...
#[test]
fn test_str_value() {
    use bolivar::pdftypes::str_value;
    assert_eq!(
...
#[test]
fn test_list_value() {
    use bolivar::pdftypes::list_value;
...
#[test]
fn test_dict_value() {
    use bolivar::pdftypes::dict_value;
    let mut m = HashMap::new();
