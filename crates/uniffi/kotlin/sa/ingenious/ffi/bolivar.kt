...
internal object IntegrityCheckingUniffiLib {
    ...
    external fun uniffi_bolivar_uniffi_checksum_method_nativepagesummarycursor_cancel(): Int

    external fun uniffi_bolivar_uniffi_checksum_method_nativepagesummarycursor_next(): Int
    ...
    external fun uniffi_bolivar_uniffi_checksum_method_nativepdfdocument_page_summaries(): Int
...
internal object UniffiLib {
    ...
    external fun uniffi_bolivar_uniffi_fn_clone_nativepagesummarycursor(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    external fun uniffi_bolivar_uniffi_fn_free_nativepagesummarycursor(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    external fun uniffi_bolivar_uniffi_fn_method_nativepagesummarycursor_cancel(
        `ptr`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    external fun uniffi_bolivar_uniffi_fn_method_nativepagesummarycursor_next(
        `ptr`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue
    ...
    external fun uniffi_bolivar_uniffi_fn_method_nativepdfdocument_page_summaries(
        `ptr`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_bolivar_uniffi_checksum_method_nativepagesummarycursor_cancel() != 46573) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_bolivar_uniffi_checksum_method_nativepagesummarycursor_next() != 14085) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_bolivar_uniffi_checksum_method_nativepdfdocument_page_summaries() != 46060) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface NativePageSummaryCursorInterface {
    fun `cancel`()

    fun `next`(): PageSummary?

    companion object
}

open class NativePageSummaryCursor :
    Disposable,
    AutoCloseable,
    NativePageSummaryCursorInterface {
    /**
     * @suppress
     */
    @Suppress("UNUSED_PARAMETER")
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_bolivar_uniffi_fn_free_nativepagesummarycursor(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall { status ->
            UniffiLib.uniffi_bolivar_uniffi_fn_clone_nativepagesummarycursor(handle, status)
        }
    }
    ...
    override fun `cancel`() =
        callWithHandle {
            uniffiRustCall { _status ->
                UniffiLib.uniffi_bolivar_uniffi_fn_method_nativepagesummarycursor_cancel(
                    it,
                    _status,
                )
            }
    ...
    override fun `next`(): PageSummary? =
        FfiConverterOptionalTypePageSummary.lift(
            callWithHandle {
                uniffiRustCallWithError(BolivarException) { _status ->
                    UniffiLib.uniffi_bolivar_uniffi_fn_method_nativepagesummarycursor_next(
                        it,
                        _status,
                    )
                }
 ...
 * @suppress
 */
public object FfiConverterTypeNativePageSummaryCursor : FfiConverter<NativePageSummaryCursor, Long> {
    override fun lower(value: NativePageSummaryCursor): Long = value.uniffiCloneHandle()

    override fun lift(value: Long): NativePageSummaryCursor = NativePageSummaryCursor(UniffiWithHandle, value)

    override fun read(buf: ByteBuffer): NativePageSummaryCursor = lift(buf.getLong())

    override fun allocationSize(value: NativePageSummaryCursor) = 8UL

    override fun write(
        value: NativePageSummaryCursor,
        buf: ByteBuffer,
    ) {
...
public interface NativePdfDocumentInterface {
    ...
    fun `pageSummaries`(): NativePageSummaryCursor
...
open class NativePdfDocument :
    ...
    @Throws(BolivarException::class)
    override fun `pageSummaries`(): NativePageSummaryCursor =
        FfiConverterTypeNativePageSummaryCursor.lift(
            callWithHandle {
                uniffiRustCallWithError(BolivarException) { _status ->
                    UniffiLib.uniffi_bolivar_uniffi_fn_method_nativepdfdocument_page_summaries(
                        it,
                        _status,
                    )
                }
 ...
 * @suppress
 */
public object FfiConverterOptionalTypePageSummary : FfiConverterRustBuffer<PageSummary?> {
    override fun read(buf: ByteBuffer): PageSummary? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypePageSummary.read(buf)
    }

    override fun allocationSize(value: PageSummary?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypePageSummary.allocationSize(value)
        }
    }
    ...
    override fun write(
        ...
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypePageSummary.write(value, buf)
        }
    }
}
